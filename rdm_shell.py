...
def debug(string, debug):
    if (debug):
        print("\033[93m[DEBUG] "+_reset+string)

def prompt(b):
#    print("""
    print(bcolors.BOLD)
    print("\t" + b +"  __    __   ______             __             __    ")
    print("\t"+ b +" /  |  /  | /      \           /  |          _/  |_  ")
    print("\t"+ r +" $$ "+ b +"|  "+ r +"$$ "+ b +"|/"+ r +"$$$$$$ "+ b +" |  _______ "+ r +"$$"+ b +" |____     / "+ r +"$$"+ b +"   \ ")
    print("\t"+ r +" $$ "+ b +"|__"+ r +"$$ "+ b +"|"+ r +"$$"+ b +"____"+ r +"$$ "+ b +"| /       |"+ r +"$$      "+ b +"\   /"+ r +"$$$$$$  "+ b +"|")
    print("\t"+ r +" $$    $$"+ b +" | / "+ r +"   $$"+ b +"/ /"+ r +"$$$$$$$"+ b +"/"+ r +" $$$$$$$"+ b +"  |"+ r +"  $$"+ b +" \__"+ r +"$$"+ b +"/ ")
    print("\t"+ r +" $$$$$$$$"+ b +" |/"+ r +"$$$$$$"+ b +"/"+ r +"  $$"+ b +"      \ "+ r +"$$"+ b +" |  "+ r +"$$"+ b +" |"+ r +"  $$"+ b +"      \ ")
    print("\t"+ r +"       $$ "+ b +"|"+ r +"$$ "+ b +"|_____"+ r +"  $$$$$$ "+ b +" |"+ r +"$$ "+ b +"| "+ r +" $$ "+ b +"|   "+ r +"$$$$$$  "+ b +"|")
    print("\t"+ r +"       $$ "+ b +"|"+ r +"$$ "+ b +"      |/ "+ r +"    $$"+ b +"/ "+ r +"$$ "+ b +"| "+ r +" $$ "+ b +"|  /  \__"+ r +"$$ "+ b +"|")
    print("\t"+ r +"       $$"+ b +"/ "+ r +"$$$$$$$$"+ b +"/ "+ r +"$$$$$$$"+ b +"/  "+ r +"$$"+ b +"/   "+ r +"$$"+ b +"/  "+ r +" $$    $$"+ b +"/ ")
    print("\t"+ r +"                                            $$$$$$"+ b +"/  ")
    print("\t"+ r +"                                              $$     " + _reset)
